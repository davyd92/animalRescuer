...
public class AnimalFood {
    ...
    public int getIncreaseHealthCondition() {

        return increaseHealthCondition;
    }

    public void setIncreaseHealthCondition(int increaseHealthCondition) {
        this.increaseHealthCondition = increaseHealthCondition;
    }

    public int getIncreaseHungerSensation() {

        return increaseHungerSensation;
    }

    public void setIncreaseHungerSensation(int increaseHungerSensation) {
        this.increaseHungerSensation = increaseHungerSensation;
    }
