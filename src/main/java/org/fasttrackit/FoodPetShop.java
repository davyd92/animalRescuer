...
public class FoodPetShop {
    ...
    public void setDogFood(boolean dogFood) {
    ...
    public boolean isReptileFood() {

        return reptileFood;
    }

    public void setReptileFood(boolean reptileFood) {
        this.reptileFood = reptileFood;
    }

    public boolean isTurtleFood() {

        return turtleFood;
    }

    public void setTurtleFood(boolean turtleFood) {
        this.turtleFood = turtleFood;
    }
    ...
    public void setCatFood(boolean catFood) {
